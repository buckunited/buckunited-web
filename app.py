...
# --- STANDARD VIEW ---
    if st.session_state.view_mode == "Standard":
        ...
        if "error" in result:
            st.error("### 📉 Negative Amortization Detected")
            st.write("""
            Your monthly budget is currently lower than the monthly interest being generated by your debts. 
            **This means your total debt will actually grow every month, not shrink.**
            
            To fix this, you must increase your monthly payment until it covers:
            1. The total interest being charged each month.
            2. At least $1.00 toward the principal balance.
            """)
            st.info("💡 **Pro Tip:** Aim for a budget at least 10% higher than your current monthly interest to start seeing your debt drop.")
        else:
